...
export class CinematicMotionV14{
 ...
 get ready(){return this.contacts.ready&&this.legacy.ready&&(this.teamworkAt===null||this.rescued&&this.clock-this.teamworkAt>7000)&&(this.snowAt===null||this.snowDone);}
