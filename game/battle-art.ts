...
export function preloadBattleArt(scene: Phaser.Scene) {preloadV21(scene);preloadV22(scene);preloadV23(scene);preloadV10(scene);preloadV11(scene);preloadV13(scene);preloadEffects(scene);preloadCinemaArt(scene);preloadCharacterArt(scene);preloadV15(scene);
...
export function registerBattleArt(scene: Phaser.Scene) {registerV21(scene);registerV22(scene);registerV23(scene);registerV10(scene);registerV11(scene);registerV13(scene);registerEffects(scene);registerCinemaArt(scene);registerCharacterArt(scene);registerV15(scene);
