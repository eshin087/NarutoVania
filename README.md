...
The revised tuning targets short, forgiving fights of roughly 45–75 seconds for ordinary play; efficient counters and ultimates can finish them faster. Sakura's protection objective lasts 50 seconds. The active-play timer excludes pauses and cinematics, includes retries, and resets when continuing a saved checkpoint in a new session. Only settings and the current chapter checkpoint persist locally; legacy saves begin at the boss-rush opening.
